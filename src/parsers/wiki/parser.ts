/**
 * @file src/parsers/wiki/parser.ts
 * @description Parses Wikipedia wikitext into the structured GWALN JSON
 *              snapshots consumed by downstream tooling (`data/wiki/<topic>.parsed.json`).
...
import {
  stripInfobox,
  stripMetaTemplates,
  stripNonCiteTemplates,
  stripFootnoteTemplates,
...
import { splitSentences, GROK_BANNER_PATTERNS } from './sentence-splitter';
import type {
  ArticleMetadata,
  ExternalCitation,
  StructuredSentence,
