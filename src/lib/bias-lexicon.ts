...
export const biasCategories: BiasCategory[] = [
    ...
    },
    {
        ...
        description: "Vague attributions should be replaced with concrete sourcing (Wikipedia MOS:WEASEL).",
    ...
    },
    {
        ...
        description: "Terms such as 'alleged' or 'so-called' should be sourced (Wikipedia MOS:ALLEGED).",
        reference: "MOS:ALLEGED",
        severity: 2,
        patterns: ["supposed", "apparent", "purported", "alleged", "accused", "so-called"].map(wordPattern)
    },
    {
        id: "editorializing",
        label: "Editorializing adverbs",
        description: "Avoid instructive adverbs like 'clearly' or 'of course' unless quoting a source (Wikipedia MOS:EDITORIAL).",
